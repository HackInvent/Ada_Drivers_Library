...
package STM32_SVD.LPTIM is
   ...
   subtype LPTIM_CFGR2_IN1SEL_Field is STM32_SVD.UInt2;
   subtype LPTIM_CFGR2_IN2SEL_Field is STM32_SVD.UInt2;
   ...
   --  LPTIM configuration register 2
   type LPTIM_CFGR2_Register_1 is record
      --  LPTIM Input 1 selection
      IN1SEL        : LPTIM_CFGR2_IN1SEL_Field := 16#0#;
      --  unspecified
   ...
   type LPTIM3_Peripheral is record
      ...
      CNT         : aliased CNT_Register;
      --  LPTIM configuration register 2
      LPTIM_CFGR2 : aliased LPTIM_CFGR2_Register_1;
   end record
     with Volatile;
