...
package STM32_SVD.QUADSPI is
   ...
   subtype QUADSPI_CCR_INSTRUCTION_Field is STM32_SVD.Byte;
   subtype QUADSPI_CCR_IMODE_Field is STM32_SVD.UInt2;
   subtype QUADSPI_CCR_ADMODE_Field is STM32_SVD.UInt2;
   subtype QUADSPI_CCR_ADSIZE_Field is STM32_SVD.UInt2;
   subtype QUADSPI_CCR_ABMODE_Field is STM32_SVD.UInt2;
   subtype QUADSPI_CCR_ABSIZE_Field is STM32_SVD.UInt2;
   ...
   subtype QUADSPI_PIR_INTERVAL_Field is STM32_SVD.UInt16;
   ...
   subtype QUADSPI_LPTR_TIMEOUT_Field is STM32_SVD.UInt16;
   ...
   type QUADSPI_Peripheral is record
      ...
      QUADSPI_DLR   : aliased STM32_SVD.UInt32;
      --  QUADSPI communication configuration register
      QUADSPI_CCR   : aliased QUADSPI_CCR_Register;
      --  QUADSPI address register
      QUADSPI_AR    : aliased STM32_SVD.UInt32;
      --  QUADSPI alternate bytes registers
      QUADSPI_ABR   : aliased STM32_SVD.UInt32;
      --  QUADSPI data register
      QUADSPI_DR    : aliased STM32_SVD.UInt32;
      --  QUADSPI polling status mask register
      QUADSPI_PSMKR : aliased STM32_SVD.UInt32;
      --  QUADSPI polling status match register
      QUADSPI_PSMAR : aliased STM32_SVD.UInt32;
      --  QUADSPI polling interval register
