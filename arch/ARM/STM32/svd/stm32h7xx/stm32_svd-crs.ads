...
package STM32_SVD.CRS is
   ...
   subtype CRS_CR_SYNCOKIE_Field is STM32_SVD.Bit;
   subtype CRS_CR_SYNCWARNIE_Field is STM32_SVD.Bit;
   subtype CRS_CR_ERRIE_Field is STM32_SVD.Bit;
   subtype CRS_CR_ESYNCIE_Field is STM32_SVD.Bit;
   subtype CRS_CR_CEN_Field is STM32_SVD.Bit;
   subtype CRS_CR_AUTOTRIMEN_Field is STM32_SVD.Bit;
   subtype CRS_CR_SWSYNC_Field is STM32_SVD.Bit;
   subtype CRS_CR_TRIM_Field is STM32_SVD.UInt6;

   --  CRS control register
   type CRS_CR_Register is record
      --  SYNC event OK interrupt enable
      SYNCOKIE       : CRS_CR_SYNCOKIE_Field := 16#0#;
      --  SYNC warning interrupt enable
      SYNCWARNIE     : CRS_CR_SYNCWARNIE_Field := 16#0#;
      --  Synchronization or trimming error interrupt enable
      ERRIE          : CRS_CR_ERRIE_Field := 16#0#;
      --  Expected SYNC interrupt enable
      ESYNCIE        : CRS_CR_ESYNCIE_Field := 16#0#;
      --  unspecified
      ...
      AUTOTRIMEN     : CRS_CR_AUTOTRIMEN_Field := 16#0#;
      ...
      --  cleared by hardware.
      SWSYNC         : CRS_CR_SWSYNC_Field := 16#0#;
   ...
   subtype CRS_CFGR_RELOAD_Field is STM32_SVD.UInt16;
   subtype CRS_CFGR_FELIM_Field is STM32_SVD.Byte;
   subtype CRS_CFGR_SYNCDIV_Field is STM32_SVD.UInt3;
   subtype CRS_CFGR_SYNCSRC_Field is STM32_SVD.UInt2;
   subtype CRS_CFGR_SYNCPOL_Field is STM32_SVD.Bit;
   ...
   type CRS_CFGR_Register is record
      ...
      SYNCPOL        : CRS_CFGR_SYNCPOL_Field := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CRS_ISR_SYNCOKF_Field is STM32_SVD.Bit;
   subtype CRS_ISR_SYNCWARNF_Field is STM32_SVD.Bit;
   subtype CRS_ISR_ERRF_Field is STM32_SVD.Bit;
   subtype CRS_ISR_ESYNCF_Field is STM32_SVD.Bit;
   subtype CRS_ISR_SYNCERR_Field is STM32_SVD.Bit;
   subtype CRS_ISR_SYNCMISS_Field is STM32_SVD.Bit;
   subtype CRS_ISR_TRIMOVF_Field is STM32_SVD.Bit;
   subtype CRS_ISR_FEDIR_Field is STM32_SVD.Bit;
   subtype CRS_ISR_FECAP_Field is STM32_SVD.UInt16;
   ...
   type CRS_ISR_Register is record
      ...
      SYNCWARNF      : CRS_ISR_SYNCWARNF_Field;
      ...
      SYNCMISS       : CRS_ISR_SYNCMISS_Field;
   ...
   subtype CRS_ICR_SYNCOKC_Field is STM32_SVD.Bit;
   subtype CRS_ICR_SYNCWARNC_Field is STM32_SVD.Bit;
   subtype CRS_ICR_ERRC_Field is STM32_SVD.Bit;
   subtype CRS_ICR_ESYNCC_Field is STM32_SVD.Bit;
   ...
   type CRS_ICR_Register is record
      ...
      SYNCOKC       : CRS_ICR_SYNCOKC_Field := 16#0#;
      --  SYNC warning clear flag Writing 1 to this bit clears the SYNCWARNF
      --  flag in the CRS_ISR register.
      SYNCWARNC     : CRS_ICR_SYNCWARNC_Field := 16#0#;
