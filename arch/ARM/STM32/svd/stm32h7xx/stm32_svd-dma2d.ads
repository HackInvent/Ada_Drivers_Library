...
package STM32_SVD.DMA2D is
   ...
   subtype DMA2D_FGOR_LO_Field is STM32_SVD.UInt14;
   ...
   subtype DMA2D_BGOR_LO_Field is STM32_SVD.UInt14;
   ...
   subtype DMA2D_FGCOLR_BLUE_Field is STM32_SVD.Byte;
   subtype DMA2D_FGCOLR_GREEN_Field is STM32_SVD.Byte;
   subtype DMA2D_FGCOLR_RED_Field is STM32_SVD.Byte;
   ...
   subtype DMA2D_BGCOLR_BLUE_Field is STM32_SVD.Byte;
   subtype DMA2D_BGCOLR_GREEN_Field is STM32_SVD.Byte;
   subtype DMA2D_BGCOLR_RED_Field is STM32_SVD.Byte;
   ...
   subtype DMA2D_OCOLR_BLUE_Field is STM32_SVD.Byte;
   subtype DMA2D_OCOLR_GREEN_Field is STM32_SVD.Byte;
   subtype DMA2D_OCOLR_RED_Field is STM32_SVD.Byte;
   subtype DMA2D_OCOLR_ALPHA_Field is STM32_SVD.Byte;
   ...
   subtype DMA2D_OOR_LO_Field is STM32_SVD.UInt14;
   ...
   subtype DMA2D_NLR_NL_Field is STM32_SVD.UInt16;
   subtype DMA2D_NLR_PL_Field is STM32_SVD.UInt14;
   ...
   subtype DMA2D_LWR_LW_Field is STM32_SVD.UInt16;
