...
package STM32_SVD.IWDG is
   ...
   subtype IWDG_KR_KEY_Field is STM32_SVD.UInt16;
   ...
   subtype IWDG_PR_PR_Field is STM32_SVD.UInt3;
   ...
   subtype IWDG_RLR_RL_Field is STM32_SVD.UInt12;
   ...
   subtype IWDG_WINR_WIN_Field is STM32_SVD.UInt12;
